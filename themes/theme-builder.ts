  ...
  const palettes = {
        ...
        "light": ['hsla(218, 50%, 48%, 1)','hsla(0, 0%, 99%, 0)','hsla(0, 0%, 99%, 0.25)','hsla(0, 0%, 99%, 0.5)','hsla(0, 0%, 99%, 0.75)','hsla(0, 0%, 99%, 1)','hsla(0, 0%, 93%, 1)','hsla(0, 0%, 88%, 1)','hsla(0, 0%, 83%, 1)','hsla(0, 0%, 77%, 1)','hsla(0, 0%, 72%, 1)','hsla(0, 0%, 66%, 1)','hsla(0, 0%, 61%, 1)','hsla(0, 0%, 55%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 10%, 1)','hsla(0, 14%, 10%, 0.75)','hsla(0, 14%, 10%, 0.5)','hsla(0, 14%, 10%, 0.25)','hsla(0, 14%, 10%, 0)','hsla(218, 50%, 62%, 1)']
      ,
        "dark": ['hsla(218, 50%, 57%, 1)','hsla(0, 0%, 18%, 0)','hsla(0, 0%, 18%, 0.25)','hsla(0, 0%, 18%, 0.5)','hsla(0, 0%, 18%, 0.75)','hsla(0, 0%, 18%, 1)','hsla(0, 0%, 22%, 1)','hsla(0, 0%, 25%, 1)','hsla(0, 0%, 29%, 1)','hsla(0, 0%, 32%, 1)','hsla(0, 0%, 36%, 1)','hsla(0, 0%, 39%, 1)','hsla(0, 0%, 43%, 1)','hsla(0, 0%, 46%, 1)','hsla(0, 0%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 95%, 1)','hsla(0, 15%, 95%, 0.75)','hsla(0, 15%, 95%, 0.5)','hsla(0, 15%, 95%, 0.25)','hsla(0, 15%, 95%, 0)','hsla(218, 50%, 43%, 1)']
      ,
        "light_accent": ['hsla(0, 0%, 83%, 1)','hsla(218, 50%, 40%, 0)','hsla(218, 50%, 40%, 0.25)','hsla(218, 50%, 40%, 0.5)','hsla(218, 50%, 40%, 0.75)','hsla(218, 50%, 40%, 1)','hsla(218, 50%, 43%, 1)','hsla(218, 50%, 46%, 1)','hsla(218, 50%, 48%, 1)','hsla(218, 50%, 51%, 1)','hsla(218, 50%, 54%, 1)','hsla(218, 50%, 57%, 1)','hsla(218, 50%, 59%, 1)','hsla(218, 50%, 62%, 1)','hsla(218, 50%, 65%, 1)','hsla(250, 50%, 95%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 55%, 1)']
      ,
        "dark_accent": ['hsla(0, 0%, 46%, 1)','hsla(218, 50%, 35%, 0)','hsla(218, 50%, 35%, 0.25)','hsla(218, 50%, 35%, 0.5)','hsla(218, 50%, 35%, 0.75)','hsla(218, 50%, 35%, 1)','hsla(218, 50%, 38%, 1)','hsla(218, 50%, 41%, 1)','hsla(218, 50%, 43%, 1)','hsla(218, 50%, 46%, 1)','hsla(218, 50%, 49%, 1)','hsla(218, 50%, 52%, 1)','hsla(218, 50%, 54%, 1)','hsla(218, 50%, 57%, 1)','hsla(218, 50%, 60%, 1)','hsla(250, 50%, 90%, 1)','hsla(250, 50%, 95%, 1)','hsla(249, 52%, 95%, 0.75)','hsla(249, 52%, 95%, 0.5)','hsla(249, 52%, 95%, 0.25)','hsla(249, 52%, 95%, 0)','hsla(0, 0%, 29%, 1)']
